...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-f', "--flavour", choices=flavours, required=False, default='yolov8n.pt',help="Choose YOLO flavour"
    )
    ...
    if model_type:
        ...
        if model_type == "YOLO":
            yoloTrain(config_file="configuration/config_yolo.yaml", flavour=args.flavour, client=client)
        else:
